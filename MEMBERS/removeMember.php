...
<body>
    ...
    ?>
    <h1>CONFIRMATION</h1>
    <form method='post' action='removeMember.php?viewid=<?php echo $personId;?>'>
    ...
    if (isset($_POST['remove'])) {
        ...
        usleep(100000);?>
        <a><?php echo "Suppression effectué !";?></a>
    <?php
    }?>
    <br>
    <br>
    <a class="navLinks" href='indexMembers.php'>Retour à la liste des membres</a>
